...
const FlightCard = ({ flightNumber, from, to, date, onJoin }) => {
  return (
    <motion.div
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="mt-4 flex items-center">
          <div className="min-w-0 flex-1">
            <p className="text-base text-neutral-900 truncate">{from}</p>
          </div>
          ...
          <div className="min-w-0 flex-1 text-right">
            <p className="text-base text-neutral-900 truncate">{to}</p>
          </div>
        </div>
